  ...
  return (
    <>
      <style>{`
        ...
        .sp-card { background: var(--surface-container-lowest); border: 1px solid var(--outline-variant); border-radius: 20px; padding: var(--space-lg); margin-bottom: 12px; box-shadow: var(--shadow-card); }
        ...
        .sp-invite-card { background: var(--primary-container); border: 1px solid var(--primary); border-radius: 20px; padding: var(--space-lg); margin-bottom: 12px; }
      `}</style>
