  ...
  return (
    <>
      <style>{`
        ...
        .th-title { font-family: var(--font-display); font-size: var(--text-headline-lg); font-weight: 800; color: var(--heading); margin-bottom: 14px; }

        .th-h { font-family: var(--font-display); font-size: 15px; font-weight: 800; color: var(--heading); margin: 6px 0 10px; }

        /* Modo de color */
        .th-modes { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-bottom: var(--space-xl); }
        .th-mode { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 7px; padding: 16px 8px; border-radius: 16px; border: 2px solid var(--outline-variant); background: var(--surface-container-lowest); color: var(--on-surface-variant); cursor: pointer; font-family: var(--font-body); font-weight: 700; font-size: 13px; transition: all var(--transition-fast); }
        ...
        .th-card { position: relative; display: flex; align-items: center; gap: 12px; text-align: left; cursor: pointer; border-radius: 999px; padding: 10px 14px 10px 10px; border: 2px solid var(--outline-variant); background: var(--surface-container-lowest); transition: all var(--transition-fast); }
        ...
        .th-name { font-family: var(--font-display); font-weight: 800; font-size: 14.5px; color: var(--heading); line-height: 1.15; }
        .th-check { position: absolute; top: 50%; right: 12px; transform: translateY(-50%); width: 22px; height: 22px; border-radius: 50%; background: var(--primary); color: #fff; display: flex; align-items: center; justify-content: center; }
