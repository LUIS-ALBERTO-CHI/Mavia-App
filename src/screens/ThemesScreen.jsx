  ...
  return (
    <>
      <style>{`
        ...
        .th-name { font-family: var(--font-display); font-weight: 700; font-size: var(--text-body-size); color: var(--heading); line-height: 1.15; }
        ...
        .th-note { margin-top: 18px; font-size: var(--text-caption-size); color: var(--on-surface-variant); text-align: center; }
      `}</style>
